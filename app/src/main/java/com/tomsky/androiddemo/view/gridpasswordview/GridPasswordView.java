package com.tomsky.androiddemo.view.gridpasswordview;
...
import com.tomsky.androiddemo.view.gridpasswordview.imebugfixer.ImeDelBugFixedEditText;
...
//        setOrientation(HORIZONTAL);
    ...
    private void inflaterViews(Context context) {
        ...
        LinearLayout containerView = (LinearLayout) findViewById(R.id.text_container_view);
//        mViewArr[0] = mInputView;

        int index = 0;
        while (index < mPasswordLength - 1) {

            TextView textView = (TextView) inflater.inflate(R.layout.passwordview_textview, null);
            setCustomAttr(textView);
            LayoutParams textViewParams = new LayoutParams(0, LayoutParams.MATCH_PARENT, 1f);
            containerView.addView(textView, textViewParams);

            View dividerView = inflater.inflate(R.layout.passwordview_divider, null);
            ...
            containerView.addView(dividerView, dividerParams);
...
//            }
        ...
        public void afterTextChanged(Editable s) {
            ...
            if (length > 0 && length <= mPasswordLength) {
                for (int i = 0; i < length; i++) {
                    mPasswordArr[i] = String.valueOf(newStr.charAt(i));
                    mViewArr[i].setText(mPasswordArr[i]);
                }
            }
            notifyTextChanged();
//            mInputView.setText(newStr);
        }
    };
